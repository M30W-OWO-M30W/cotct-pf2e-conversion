...
AW("yargin-balko", B.npc(A["yargin"],"Yargin Balko",1,16,20,5,5,7,6,
  ...
  [B.strike(nid(),"Acid Flask",7,"1d6","acid",["range-increment-20","splash","alchemical","bomb"],[("1","persistent-acid")]),
   ...
   B.action(nid(),"Quick Acid","1","<p>Yargin Interacts to draw an Acid Flask, then Strikes with it.</p>",["alchemical"]),
   B.lore(nid(),"Alchemy Lore",7)],
  notes="<p><strong>Role:</strong> Gaedren's fence; answers the front door, fights from A6. Opens with thrown Acid Flasks, falls back to crossbow. <strong>Flees down the hidden trapdoor to warn Gaedren if losing.</strong> Carries three acid flasks and the brass key (all fishery doors).</p>",
...
AW("giggles", B.npc(A["giggles"],"Giggles",1,16,24,7,5,3,5,
  ...
  [B.strike(nid(),"Flail",7,"1d6+3","bludgeoning",["sweep","trip"],slug="flail"),
