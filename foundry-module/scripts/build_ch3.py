...
PG("Part 2 — The Emperor of Old Korvosa", SR("Part 2 — Emperor of Old Korvosa", 150)
  ...
  + B.s_skill("<p><strong>Researching the Emperor:</strong> each attempt takes 1d4 hours and a Diplomacy check to Gather Information (treat it as nearly impossible from off the island — the quarantine has strangled gossip). Results are cumulative:</p>"
    "<ul>"
    "<li>"+chk("type:diplomacy|dc:10")+" — the Emperor rules Old Dock from a seized tenement 'palace' on <strong>Silk Street</strong> and rarely leaves it. His fanatics sweep Old Dock for conscripts; those who refuse are taken anyway — for other purposes.</li>"
    "<li>"+chk("type:diplomacy|dc:15")+" — Old Korvosa is his stage: prisoners are forced into deadly games and gruesome performances against his pets and followers, and the rest are beheaded by his favourite toy, an extravagant guillotine he calls the <strong>'Tall Knife.'</strong></li>"
    "<li>"+chk("type:diplomacy|dc:20")+" — an audience must be <em>earned</em> with entertainment. His current obsession is a brutal game of his own invention, <strong>blood pig</strong>, played on a converted rooftop field in the palace every evening; the howling of players and crowd carries across Old Dock.</li>"
    "<li>"+chk("type:diplomacy|dc:30")+" — the Emperor's real name: <strong>Pilts Swastel</strong>, pre-quarantine owner of the notorious Old Korvosa theater <em>Exemplary Execrables</em>.</li>"
    "</ul>")
...
area3("D1-D3", "Entrance, Lounge & Chamidu", SR("D1-D3", 162)
  ...
  + "<p>A permanent <em>magic mouth</em> trumpets (and the elephant-head animates) for any visitor not wearing the Arkona crest. The fireplace-warmed lounge (D2) is the waiting room — and the watching room.</p>"
...
PG("E. The Vivified Labyrinth", SR("E — The Vivified Labyrinth", 176)
  ...
  + B.s_skill("<p><strong>The rotation has teeth.</strong> A pulled lever <strong>locks for 1 minute</strong> ("+chk("type:thievery|dc:30")+", taking a full round at the mechanism, overrides the lockout for one extra pull). All four sections turn together over 1 round per 90°, bells ringing in the Gizzard and the grinding plainly audible through E1-E20 — and the openings between sections slam shut <em>fast</em>:</p>"
    "<ul>"
    "<li><strong>Caught astride a seam</strong> (a transitional square): "+chk("type:reflex|dc:15")+" — on a success the creature flings itself 5 ft to either side, clear of the seam; on a failure the closing walls <strong>scissor it for @Damage[6d10[bludgeoning]]</strong> and shunt it into a random adjacent non-transitional square.</li>"
    "<li><strong>Riding a turning section:</strong> "+chk("type:acrobatics|dc:10")+" to keep footing or fall "+B.cond("prone", "Prone")+".</li>"
    "<li>"+chk("type:perception|dc:15")+" at any seam reveals the tell-tale floor-and-ceiling gaps before the first pull.</li>"
    "</ul>"
