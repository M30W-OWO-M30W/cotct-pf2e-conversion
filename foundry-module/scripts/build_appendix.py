...
# Supplemental Rulings registry — module-authored checks in Olliebird style
# (generated by gen_supplemental.py from research/supplemental_rulings.json)
_SUPPL = pathlib.Path(__file__).resolve().parent / "supplemental_rulings.html"
if _SUPPL.exists():
    add_page("00-conversion-guide", "appPgSupplRul001",
             "Supplemental Rulings — Module-Authored Checks",
             _SUPPL.read_text(encoding="utf-8"))
else:
    print("  [patch] SKIP supplemental rulings page (scripts/supplemental_rulings.html missing)")
