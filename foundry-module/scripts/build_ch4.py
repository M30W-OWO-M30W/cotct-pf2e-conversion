...
area4("A1-A3", "Thrallkeeper's Walk, the Pool & the Gallery", SR("A1-A3", 209)
  ...
  + "<p><strong>A1:</strong> the dust tells its story — "+chk("type:survival|dc:4")+" notes four human-sized creatures recently passed from the stairs toward the east room; "+chk("type:survival|dc:19")+" follows the trail to the A2/A3 door (where the Sklar-Quah wait). Within 10 feet of A2 the floor runs clean. If the assassins arrive while the PCs are busy in A2, two hide here while two Sneak inside; otherwise all four Stealth into A2 in pairs.</p>"
...
area4("A4-A7", "Shrines, the Illumacore & the Eternal Glyphs", SR("A4-A7", 211)
  ...
  + "<p><strong>A4:</strong> the serpent-woman shrine ("+chk("type:religion|dc:25")+": <strong>Kurshu the Undying</strong>, Lissala's herald, unprayed-to for millennia) — sapphire and emerald slivers in the tail, ~320 gp re-scaled (the thundercallers hoot at it: +2 Noise).</p>"
  ...
  + "<p><strong>A6:</strong> the Lissala statue — her jade whip is a <strong>+2 axiomatic whip</strong>, cursed (1 Wisdom drain/day of visions; −6 Will saves while Thassilonian writing is visible; lifts only re-handed to the statue or <em>remove curse</em> vs. 18th). The base drawer ("+chk("type:perception|dc:20")+" to notice) holds a 4-ft wedge-plate frame: align it ("+chk("type:thievery|dc:20")+") over the illumacore and the shaft-light projects the <strong>original acropolis map</strong> on the ceiling — today's rooms a small fraction of what sprawled here.</p>"
...
area4("A8-A11", "The Lower Level & the Golarion Globe", SR("A8-A11", 213)
  ...
  + "<p><strong>A9:</strong> beyond the havero's reach — noise down here cannot rouse it unless truly thunderous (the Mantis love an ambush ringing the illumacore landing, or set north to catch PCs leaving A11). A 120-ton stone plug ("+chk("type:perception|dc:22")+") hides the hallway east.</p>"
  ...
  + SEC("<p><strong>A11, the Golarion Globe:</strong> a hollow 10-ft stone globe of the pre-Earthfall world ("+chk("type:society|dc:20")+" — landlocked Varisia, no Inner Sea, continents that no longer exist; "+chk("type:arcana|dc:30")+" on its aura deduces its function and the exit method) floating on <strong>three immovable rods</strong>. Touch it and contemplate the <em>stars</em> → drawn inside into suspended animation and space-visions ("+chk("type:will|dc:15")+" per minute or 1d4 Intelligence drain; concentrate on Golarion to exit; auto-ejected at Int 0). Exit grants the <strong>THRALLKEEPER'S MARK</strong> (one palm, one week, once per year): right palm = <em>banishment</em> 1/day; left = <em>summon</em> (5th rank) 1/day; either grants +4 status vs. mental. Pulling a rod drops the globe (+10 Noise; @Damage[5d6[bludgeoning]] to anyone beneath, "+chk("type:reflex|dc:15")+" avoids; it cracks — 1d4 more weeks of function). <strong>+3 RP</strong> for gaining the Mark before Shoanti eyes; <strong>story award</strong> if any PC gains it.</p>")
...
PG("Quest B: The House of the Moon", SR("B. House of the Moon", 218)
  ...
  + "<p>Thousand Bones's pointer: Truthspeaker <strong>Akram</strong> arrives with the Lyrune-Quah in days — but a <strong>red reaver</strong> has taken the shrine, eating a dozen moon maidens and their commander. <strong>Tekrakai's</strong> surviving band of four ("+chk("type:perception|dc:20")+" on Sense Motive reads their worry; "+chk("type:diplomacy|dc:30")+" or "+chk("type:intimidation|dc:23")+" to bench them — but doing so costs <strong>−2d4 RP</strong>) wants it dead; her briefing is exact: rending claws, a discord-roar, <strong>distracted by artistic beauty</strong>, never sleeps. Killing it unannounced earns the same gratitude.</p>"
...
PG("Part 3: Mantis and Maiden", SR("Part 3: Mantis and Maiden", 234)
  ...
  + SEC("<p><strong>The secret</strong> ("+chk("type:society|dc:10")+" knows the vault: where Korvosa's most violent criminals are jailed and often executed): for years the Society traded 'stock' to the <strong>derros</strong> in the caverns adjoining the vault; in exchange the guild smuggled prisoners out through the derro warrens, swapping in insane patsies. The derros have been silent for months — Boule is convinced the Gray Maidens and Red Mantis found the caverns and use them now. The sewer secret door still works. His extras: a <strong>partial key</strong>, directions (+20 circumstance to the E1/E2, E6, and E9 secret doors) — and fake 'Korvosan Revolution' ciphers leaked to "+act(A4["kordaitra"], "Kordaitra")+", nailing the would-be codebreaker to her quarters for at least a week. <strong>The Arkona papers (D16):</strong> shown he's compromised, Boule pales and offers <strong>600 pp per PC</strong> ("+chk("type:diplomacy|dc:25")+" raises it to 900; <strong>story award</strong> for brokering <em>favors</em> for the Korvosan Guard instead of coin, Kroft's preference — and if the PCs keep copies and Boule learns of it, he retaliates).</p>")
...
area4("E1-E4", "The Red Mantis Caverns", SR("E1-E4", 237)
  ...
  + B.enc("E3 — the Chokepoint", encx([9, 9, 9], 12),
     "<p>The "+haz(A4["dispellingmist"], "Dispelling Mist")+" at the entry; a 60-ft spike-rocked pit (@Damage[8d6[bludgeoning]]) bridged by a <em>permanent-image</em> plank ("+chk("type:will|dc:17")+" on interaction — the assassins jump or climb, "+chk("type:athletics|dc:15")+" on the walls); the east pool is drinkable but bitter (the garrison's water source); cytillesh patches ("+B.cond("stupefied", "Stupefied")+" creep within 20 ft per day — the assassins ration exposure under 20 hours); and 2 "+act(A4["manananggal"], "manananggals")+" — the late Sable officers Banzul and Wevenner — plus a hidden "+act(RMA, "Red Mantis assassin")+" beyond the pit who watches two rounds, then slips to E4 to report.</p>"
...
area4("E7-E11", "Crypts, the Daemon & the Mother of Thorns", SR("E7-E11", 245)
  ...
  + "<p><strong>E7:</strong> looted Shoanti sarcophagi ("+chk("type:society|dc:25")+"), used since as derro cages. Nothing of value remains.</p>"
  ...
  + "<p><strong>E8, Zenobia's Crypt:</strong> once a great Shoanti shaman's tomb ("+chk("type:society|dc:25")+" reads the carvings), then a derro necromantic workshop. By night her headless body lies in the west sarcophagus and the manananggals' torsos in the others ("+chk("type:religion|dc:27")+": destroying torsos destroys their owners; destroying <em>Zenobia's</em> body only ends her living masquerade — the vinegar vats are how she fits back into it).</p>"
  ...
  + "<p><strong>E9:</strong> the Society's secret stair ("+chk("type:perception|dc:40")+" at either end, +20 from Boule) — saboteur work so audacious the arbiters never thought to look for it.</p>"
...
area4("E12-E21", "The Gray Maiden Dungeons", SR("E12-E21", 248)
  ...
  + "<p><strong>E12 — Observation office:</strong> the old execution-records office (the files still moulder in the cabinet); the commanders watch the Mother of Thorns work through the window, coming and going by the secret tunnel ("+chk("type:perception|dc:30")+" for its doors).</p>"
  + "<p><strong>E13 — Deathhead Cells:</strong> cot-and-chamber-pot cells holding <strong>12 imprisoned "+act(A4["gmrecruit"], "recruits")+"</strong> who refused the Maidens — beaten to 1d4 HP, no condition to aid anyone (Boule's or Kordaitra's keys, or "+chk("type:thievery|dc:40")+" on the iron gates) — <strong>story award per woman freed</strong> (15 total with E18). <strong>E14 — The secret cell:</strong> "+act(A4["endrin"], "Marcus Endrin")+" (see his entry; Boule's advice does <em>not</em> help find this door — the E20 records reveal it, +20 circumstance).</p>"
  ...
  + B.s_treasure("<p><strong>E21 — Kordaitra:</strong> "+act(A4["kordaitra"], "the conditioner")+" at Boule's ciphers (≥1 week to crack; if she succeeds first she decamps to the castle with everything below). The painting — <em>Sinister Sister</em>, Goren Andosalu of Magnimar, 3×6 ft, 40 lbs — ~450 gp re-scaled. Secret door "+chk("type:perception|dc:30")+" (locked, "+chk("type:thievery|dc:40")+" or her key) to the <strong>emergency repository</strong>: a cherrywood coffer (~50 gp) of <strong>4 moderate healing potions</strong> (cure serious), <strong>3 potions of remove disease</strong>, <strong>6 potions of lesser restoration</strong>, and <strong>3 potions of gaseous form</strong>; plus <strong>2 doses of dust of disappearance</strong>, a <strong>wand of cure critical wounds</strong> (40 charges), scrolls of <em>break enchantment, heal, limited wish,</em> and <em>resurrection</em>, <strong>2 candles of truth</strong>, and <strong>3 doses of stone salve</strong> — all carried in a <strong>bag of holding (type IV)</strong>. Her key ring also holds the <strong>treasury key</strong> (see her entry — it matters in Ch.6).</p>"))
